...
#### ==Версия v1.02 от 2024-09-07==

- [ ] 1. Повторные сделки
- [ ] 2. Валидация уровня по касанию N свечей, начиная с обратного направления
- [x] 3. Запрещены дивергенции, где свечи цены пересекают линии дивергенции.
- [x] 4. Запрещены конвергенции, где свечи цены пересекают линии конвергенции.
- [x] 5. **Фильтр дивергенций/конвергенций по мин. наклону сегментов на ценовом графике.** Для этого применяется мин. расстояние ATR между вершинами дивергенции/конвергенции на графике цены. Задается настройками `ATR.DP.E` `ATR.DP.R`. Если дистанция между соседними вершинами меньше `ATR*ATR.DP.R`, то бот игнорирует дивергенцию/конвергенцию. Значение ATR берется по свече конца сегмента дивергенции/конвергенцию. Для многосегментных дивергенций/конвергенций в расчете участвуют ATR разных свечей.
...
- [ ] 7. Вместо DV.LL.BC фильтр по касанию линии на цене от активации до конца дивера . 
     Для диверов из нескольких сегментов до последнего сегмента или до каждого?"
- [ ] 8. Если событие было в ограничении по времени, то уровень не действителен, даже если позже образуется еще одна валидная дивергенция.
- [ ] 9. Ретест уровня 50% 
- [ ] 10. Сейчас дивергенция определяется по всем вершинам в зоне 60\40. Сделать опционально проверку только последней вершины
- [ ] 11. Касание фрактала без учета спреда можно сделать. А лучше весь советник чтобы по биду считал. 
Могу сделать по биду проверку касания, рисование стрелки. Вход в buy по bid сделать не получится."
...
- [x] `DV.LHF.TD.E`: Запретить пробитие уровня от касания до конца дивергенции
