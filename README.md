...
- [x] `DV.MPC`: Мин. количество последовательных сегментов дивергенции
- [x] `DV.VA`: Разрешить разнонаправленные сегменты (\/ или /\)
- [x] `DV.LL.E`: Запретить пробитие H/L свечи слева от дивергенции
- [x] `DV.LL.BC`: Количество свечей слева для проверки H/L
- [x] `DV.NBE.E`: Использовать H/L соседней свечи цены для дивергенции
