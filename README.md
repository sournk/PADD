...
- [ ] 2. Добавить раздедельные настройки для определения дивергенции (сходящаяся) и конергенции (разходящаяся).
- [ ] 3. Добавить функцию реверса стрелки.
- [ ] 4. Мин. и макс. RSI.
- [ ] 5. Поиск дивергенции в диапазоне коэффициент*атр от линии фрактала, и если дивергенция за пределами его, то вход невалиден