...
#### ==Версия v2.05 от 2024-10-13==

- [x] Поиск дивергенций левее касания уровня за `DV.DST` мин.
![DV.DST](img/UM001.DV.DST.png)

#### ==Версия v2.04 от 2024-10-12==
- [x] Фильтр фракталов `F.F.OEN`, чтобы допустить фракталы только на экстремумах за N баров на таймфрейме `F.FTF`. 

#### ==Версия v2.03 от 2024-10-12==
- [x] Debug лог для DV.HLB.E.
...
- [x] `TS.FCA.M`: Фиксированное время в сделке, мин
- [x] `TS.EC.TF`: Таймфрейм определения экспирации
- [x] `TS.EC.AL.M`: Мин.время от стрелки до конца бара экспирации, мин  
...
- [x] `DV.LHF.LL.E`: Запретить пробитие уровня слева от дивергенции/конвергенции
- [x] `DV.LHF.TD.E`: Обязательно пробитие уровня слева от дивергенции/конвергенции
